    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[10px] font-extrabold uppercase tracking-wider font-sans select-none pr-1">
            WhatsApp
          </span>
        </a>
        ...
        <a
          href="tel:9061808050"
          className="h-12 w-12 hover:w-[130px] rounded-full bg-[#224356] border-2 border-white text-white hover:bg-white hover:text-[#418C7D] hover:border-[#418C7D] flex items-center justify-start px-3 shadow-[0_4px_18px_rgba(34,67,86,0.15)] transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer group overflow-hidden whitespace-nowrap gap-3.5"
          title="Call Helpline"
        >
          <div className="flex-shrink-0 w-5 h-5 flex items-center justify-center">
